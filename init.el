...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;; workaround for mlterm
(global-set-key (kbd "ESC <M-next>") 'scroll-other-window)
(global-set-key (kbd "ESC <M-prior>") 'scroll-other-window-down)
(global-set-key (kbd "ESC <M-home>") 'beginning-of-buffer-other-window)
(global-set-key (kbd "ESC <M-end>") 'end-of-buffer-other-window)
...
(setq confirm-kill-emacs 'y-or-n-p)     ; warn on quit
;; find-file-at-point
;;(ffap-bindings)
(global-set-key "\C-x\C-f" 'ffap)
;; do not ping on host-like string
...
;;; ibuffer
;; Sort by pathname
;; https://www.emacswiki.org/emacs/IbufferMode#toc9
